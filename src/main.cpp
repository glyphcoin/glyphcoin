...
unsigned int nTargetSpacing = 1 * 90; // 30 seconds
...
const string strMessageMagic = "glyphcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "glyphcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Ipsum Nomen Res Ipsa: The Name Itself is the Thing Itself. I.N.R.I.: Isis, Apophis, Osiris: IAO.";
        CTransaction txNew;
        txNew.nTime = 1402132310;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1402132310;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1829817;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbbc011f708fbb907a6548d8b513742578938856601c314a8d56b28048db14a86"));
        block.print();
